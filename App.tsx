        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          {saveStatus === 'saved' && (
            <div className="bg-green-50 text-green-700 p-4 rounded-xl mb-8 border border-green-200 text-sm flex justify-between items-center">
              ...
              <button onClick={downloadPricingJSON} className="font-bold underline">Download pricing.json for developer</button>
            </div>
          )}
  ...
  return (
    <div className="min-h-screen bg-cream selection:bg-gold/30">
      ...
      <main>
        ...
        {activePage === 'admin-login' && renderAdminLogin()}
        {activePage === 'admin-pricing' && renderAdminPricing()}
      </main>
